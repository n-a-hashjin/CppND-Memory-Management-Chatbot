...
In this project, the program has been analyzed and modified, so advanced concepts of memory management criteria have been applied; like using smart pointers, move semantics and rule of five.
...
At very first version of program, it use to crash when the window was closed. It caused by improperly deallocating chatbot instances. In first commit it's easy to track the partial solution!!
